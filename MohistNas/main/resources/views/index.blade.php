@include('part-top')
    ...
    <div class="container-fluid"><div class="row"><!--  行1 Begin -->
        ...
        <div class="col-xl-6"> <center><div class="Panel1">
            <div class="PanelTitle"><span>{{ __('main.txt-SysMsg') }}</span><span id="Sys_spinner" class="spinner-grow float-end" style="width:6px;height:6px;margin-right:10px;margin-top:8px;visibility:hidden;"></span></div>
            ...
            <p class="PanelTextLine"><span class="PanelTextName">{{ __('main.txt-v-processes-text') }}</span>&nbsp;:&nbsp;<span id='Sys_processes'>{{$xSysInfo['Sys']['processes']}}</span></p>
            <p class="PanelTextLine"><span class="PanelTextName">{{ __('main.txt-v-networkcounts-text') }}</span>&nbsp;:&nbsp;<span id='Net_NICs'>{{$xSysInfo['Net']['NICs']}}</span></p>
        </div></center> </div>
        <!-- 2.存储信息 -->
        <div class="col-xl-6"> <center><div class="Panel1">
            <div class="PanelTitle"><span>{{ __('main.txt-StorageMsg') }}</span><span id="Storage_spinner" class="spinner-grow float-end" style="width:6px;height:6px;margin-right:10px;margin-top:8px;visibility:hidden;"></span></div>
    ...
    <div class="container-fluid"> <div class="row"><!--  行2 Begin -->
        ...
        <div class="col-xl-6"><center><div class="Panel2">
                <div class="PanelTitle"><span>{{ __('main.txt-CPUMemoryMsg') }}</span><span id="CAndM_spinner" class="spinner-grow float-end" style="width:6px;height:6px;margin-right:10px;margin-top:8px;visibility:hidden;"></span></div>
                        ...
                        <div class="col-sm" style="padding-left:0px;padding-right:0px;">
                            <div class="container-sm" style="padding-left:12px;padding-right:12px;height:170px;display:flex;flex-direction:column;justify-content:center;text-align:center;"><div class="row justify-content-center" style="min-height:85px;font-Size:11px;" >
                                    <div class="row" style="padding-left:0px;padding-right:0px;padding-top:10px;">
                                        <div class="col-auto" style="min-width:68px;padding:0px;text-align:left;">{{ __('main.txt-v-memory-text') }}&nbsp;:&nbsp;</div>
                                        <div class="col-auto" style="min-width:75px;padding:0px;text-align:left;padding-bottom:4px;"><div  id=Mt >&nbsp;</div></div>
                                    </div>
                                    <div class="row" style="padding-left:0px;padding-right:0px;">
                                        <div class="col-auto" style="min-width:68px;padding:0px;text-align:left;">{{ __('main.txt-v-memfree') }}&nbsp;:&nbsp;</div>
                                        <div class="col-auto" style="min-width:75px;padding:0px;text-align:left;padding-bottom:4px;"><div  id=Mf >&nbsp;</div></div>
                                    </div>
                                    <div class="row" style="padding-left:0px;padding-right:0px;">
                                        <div class="col-auto" style="min-width:68px;padding:0px;text-align:left;">{{ __('main.txt-v-memused') }}&nbsp;:&nbsp;</div>
        ...
        <!-- 4.网络信息 -->
        <div class="col-xl-6"> <center><div class="Panel2">
            <div class="PanelTitle"><span>{{ __('main.txt-NetMsg') }}</span><span id="Net_spinner" class="spinner-grow float-end" style="width:6px;height:6px;margin-right:10px;margin-top:8px;visibility:hidden;"></span></div>
                <div class="container-sm" style="padding-top:5px;text-align:left;font-Size:11px;" id="networks" >
                    ...
                    ?>
                    <div class="row" ><div id="network-Title-Total" style="color: #383838;padding-left:2px;font-Size:13px;font-weight: 550;overflow:hidden; text-overflow:ellipsis; white-space:nowrap;">{{ __('main.txt-v-NetTotal') }}</div><div id="network-Total" style="height:{{$NetTH}};padding-left:2px;padding-right:2px;"></div></div>
    ...
    <script type="text/javascript">
        ...
        option2 = {
            series: [{ type: 'gauge',
                ...
                detail: {
                    offsetCenter: [0, '92%'], valueAnimation: true, formatter: '{value}%\n{{ __('main.txt-v-mema-text') }}', color: '#383838', fontSize: 15
                },
                data: [{ value: 0 }]
            }]
        };
        ...
        var option4;
        option4 = {
            animation: false, backgroundColor: '#f8f8f8', title: { text: '{{ __("main.txt-v-NetinTxt") }} : 0.00KB/s , {{ __("main.txt-v-NetoutTxt") }} : 0.00KB/s', left:"16px", x: 'left', textStyle: { fontSize: 12 ,  fontWeight: 400 } },
            legend: { data: ['{{ __('main.txt-v-Netin') }}', '{{ __('main.txt-v-Netout') }}' ], textStyle: { fontSize: 12 } , right:'30px' },
            ...
            yAxis: [ 
                { name: '{{ __('main.txt-v-Netinflow') }}', nameTextStyle: { padding: [0, 0, -14, 65] , fontSize:10 } , splitNumber: 4, minInterval:1000, min:0 , max:500, type: 'value', axisLabel:{fontSize: 9 , formatter:'{value} KB/s' } } , 
                { name: '{{ __('main.txt-v-Netoutflow') }}', nameTextStyle: { padding: [0, 0, -14, -70] , fontSize:10 } , splitNumber: 4 , minInterval:1000, min:0 , max:500, nameLocation: 'start', alignTicks: true, type: 'value', inverse: true, axisLabel:{fontSize: 9 , formatter:'{value} KB/s' } }   ],
            series: [
                { name: '{{ __('main.txt-v-Netin') }}', type: 'line', smooth: true, symbol: 'none', areaStyle: {}, itemStyle: { color: '#EE9494',opacity: 0.3 }, data: NetTd },
                { name: '{{ __('main.txt-v-Netout') }}', yAxisIndex:1 , type: 'line', smooth: true, symbol: 'none', areaStyle: {}, itemStyle: { color: '#A3D3E8' }, data: NetTu}  ] 
        };
        ...
        window.addEventListener('resize',function () {  
            ...
            NetChartsTotal.resize();  {{$NetChartsResize}}
        } );
    </script>
